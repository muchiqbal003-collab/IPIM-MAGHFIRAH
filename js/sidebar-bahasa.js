...
(function() {
  ...
  const MENU_GROUPS = [
    ...
    },
    {
      ...
      collapsible: true,
      items: [
        { id: 'kelola-ujian-bulanan', label: 'Kelola Ujian Bulanan', href: 'kelola-ujian-bulanan.html', icon: 'icon-calendar' },
        { id: 'nilai-toafl', label: 'Nilai Semi TOAFL', href: 'nilai-toafl.html', icon: 'icon-pen' },
        { id: 'nilai-bulanan', label: 'Input Nilai Bulanan', href: 'nilai-bulanan.html', icon: 'icon-edit' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'rekap-ujian-bulanan', label: 'Rekap Ujian Bulanan', href: 'rekap-ujian-bulanan.html', icon: 'icon-trophy' },
  ...
  const SVG_ICONS = {
    ...
    'icon-gear': '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-2 2 2 2 0 01-2-2v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83 0 2 2 0 010-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 01-2-2 2 2 0 012-2h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 010-2.83 2 2 0 012.83 0l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 012-2 2 2 0 012 2v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 0 2 2 0 010 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 012 2 2 2 0 01-2 2h-.09a1.65 1.65 0 00-1.51 1z"/>'
  };
